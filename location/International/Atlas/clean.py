...
if __name__ == "__main__":
    ...
    # Add in other properties, like in_book and trusted
    ...
    in_book = pd.read_table("./in/list_in_atlas_book.csv", index_col="iso", sep=";")
    parent_id_table = parent_id_table.merge(in_book, left_on="code", right_index=True, how="left")
