...
if __name__ == "__main__":
    ...
    df = pd.read_table(
        "./in/col_industry_name_category_master - Hierarchy.tsv", encoding="utf-8"
    )
    ...
    names = pd.read_table(
        "./in/col_industry_name_category_master - Names.tsv", encoding="utf-8"
    )
    ...
    parent_code_table = (
        repeated_table_to_parent_id_table(
            df, h, level_fields={"section": [], "division": [], "class": []}
        )
