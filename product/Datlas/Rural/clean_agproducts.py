...
if __name__ == "__main__":
    names = pd.read_table("./in/AgProducts_Names.tsv", encoding="utf-8",
                          dtype={"code": str})

    hierarchy = pd.read_table("./in/AgProducts_Hierarchy.tsv", encoding="utf-8")
    ...
    c.to_csv("out/agricultural_products.csv")
    c.to_stata("out/agricultural_products.dta")
